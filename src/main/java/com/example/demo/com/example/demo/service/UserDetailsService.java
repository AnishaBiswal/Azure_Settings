...
public class UserDetailsService {
	...
	public HashMap<String,String> saveUserDetails(String uid,String name,String email,String position,String role)
	{
    	...
    	else
    	{
			...
			details.put("userRole",userDetailsRepo.GetRoleByEmail(email));
			return details;
    	}
