...
//	private String pom;
	...
	public FileDetails(int cid, String srcname, String srctype, byte[] src, String docname, String doctype,
			byte[] doc) {
		this.cid = cid;
		this.srcname = srcname;
		this.srctype = srctype;
	...
	public FileDetails(String jarname, String jartype, byte[] jar,int cid, String docname, String doctype,
			byte[] doc,boolean status) {
